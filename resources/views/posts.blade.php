                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-4">
                        <div class="post-type post-img">
                            <a><img src="{{ asset('storage/uploads/' . $post['url']) }}" class="img-responsive" alt="image post"></a>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-8">
                        <div class="caption">
                            <h3 class="md-heading"><a >{{ $post['title'] ?? 'The Heading Text Size Should Match' }}</a></h3>
